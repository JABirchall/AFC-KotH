...
_role1 = "Welcome on";
_role1names = ["AFC~King of the Hill~ Server"];
_role2 = "Rules";
_role2names = ["be nice", "play fair", "have fun", "dont cheat", "dont flame", "dont hate the gamer", "hate the game =)"];
_role3 = "Website";
_role3names = ["www.austrian-funclan.com"];
_role4 = "Special thanks to";
_role4names = ["Altis Army", "for making this mod", "", "itsatrap aka Ninja", "for the extDB port", "", "Soolie", "for the tradermenu"];
{
	sleep 2;
